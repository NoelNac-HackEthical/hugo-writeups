...
title: "Mon Recoweb"
slug: "mon-recoweb"
description: "Automatise la découverte de répertoires et fichiers web (whatweb + ffuf) et agrège les résultats dans mes_scans/scan_repertoires.txt."
draft: false
tags: ["scripts","tools"]
...
version: "mon-recoweb 2.1.3"
---

Automatise la découverte de répertoires et fichiers web (whatweb + ffuf) et agrège les résultats dans mes_scans/scan_repertoires.txt.
...
- Résultats agrégés dans un seul fichier :
...
Exemples :
mon-recoweb site.htb --fast
mon-recoweb permx.htb --medium --strict
mon-recoweb target.htb --custom /chemin/ma-liste.txt
```

## Téléchargements

La version courante du script mon-recoweb est 2.1.3
