...
title: "Mon Recoweb"
slug: "mon-recoweb"
description: "Reconnaissance web automatisée en 3 phases (dirb + ffuf directories + ffuf files) avec exports JSON ffuf fiables, détection soft-404 et résumé global agrégé (/répertoire/ vs /fichier). Supporte"
draft: false
tags: ["scripts","tools"]
...
version: "mon-recoweb v2.0.1"
---

Reconnaissance web automatisée en 3 phases (dirb + ffuf directories + ffuf files) avec exports JSON ffuf fiables, détection soft-404 et résumé global agrégé (/répertoire/ vs /fichier). Supporte
...
La version courante du script mon-recoweb est v2.0.1
