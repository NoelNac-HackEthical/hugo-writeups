...
title: "Test Medium Search — HTB Medium Writeup & Walkthrough"
linkTitle: "Test Medium Search"
slug: "test-medium-search"
date: 2026-06-13T16:33:41+02:00
#lastmod: 2026-06-13T16:33:41+02:00
draft: true

# --- PaperMod / navigation ---
type: "writeups"
summary: "Test Medium Search (HTB Medium) : writeup fictif utilisé uniquement pour tester la recherche par tags."
description: "Writeup de test pour valider la recherche par tags, difficulté HTB Medium et mots-clés techniques."
tags: ["Hack The Box", "HTB Medium", "linux-privesc", "tag-de-test", "recherche-tags"]
...
Cette page est un writeup fictif utilisé uniquement pour tester la recherche par tags dans la liste des writeups.
...
```bash
nmap -sCV -p- -T4 -oN scans/nmap_full.txt test-medium-search.htb
```
...
```bash
 nmap -Pn -A -sV -p"22,2222,8080,35627,42277" --script="http-vuln-*,http-shellshock,http-sql-injection,ssl-cert,ssl-heartbleed,sslv2,ssl-dh-params" --script-timeout=30s -T4 "test-medium-search.htb"
```
...
```bash
mon-recoweb test-medium-search.htb
...
```bash
mon-subdomains test-medium-search.htb
